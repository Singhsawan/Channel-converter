...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6197312036:AAGLcjgunbVYqe1a-LyOkraK_wTWJm9rYaU")
DROPLINK_API = os.environ.get("DROPLINK_API")
MDISK_API = os.environ.get("MDISK_API", "WS15eJdTOMlQzyQ7W3Pp")
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001535830032")) if os.environ.get("CHANNEL_ID") else []
